<<<<<<< HEAD:client/src/pages/DownloadTicketPage.jsx
    ...
    return (
        <div className="container mx-auto px-6 md:px-12 py-9 bg-white overflow-auto">
            ...
            <div className="mb-6 text-center flex items-center justify-center">
                ...
                <p className="text-green-600 text-2xl font-semibold mt-1 ml-2">Payment Successful!</p>
            </div>
...
>>>>>>> f149a3eaf73a802c0d4605c914eae3a3a327f76a:client/src/_root/pages/DownloadTicketPage.jsx
};
